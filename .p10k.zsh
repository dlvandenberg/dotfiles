# Generated by Powerlevel10k configuration wizard on 2023-11-12 at 09:25 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_PREFIX='%008F╭─'
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_PREFIX='%008F├─'
  typeset -g POWERLEVEL9K_MULTILINE_LAST_PROMPT_PREFIX='%008F╰─'
  ...
  if [[ $POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_CHAR != ' ' ]]; then
    ...
    typeset -g POWERLEVEL9K_MULTILINE_FIRST_PROMPT_GAP_FOREGROUND=008
  ...
  typeset -g POWERLEVEL9K_BACKGROUND=008
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%003F'   # green foreground
      local   modified='%11F'  # yellow foreground
      local  untracked='%38F'   # blue foreground
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_KUBECONTEXT_PREFIX='%015Fat '
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_TOOLBOX_PREFIX='%015Fin '
